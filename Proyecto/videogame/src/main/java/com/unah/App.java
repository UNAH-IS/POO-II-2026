...
import com.unah.clases.Item;
import com.unah.clases.JugadorAnimado;
...
public class App extends Application{
	...
	public void cargarImagenes() {
		imagenes.put("goku", new Image(getClass().getResource("goku.png").toExternalForm()));
		imagenes.put("goku-furioso", new Image(getClass().getResource("goku-furioso.png").toExternalForm()));
		imagenes.put("tilemap", new Image(getClass().getResource("tilemap.png").toExternalForm()));
		imagenes.put("megaman", new Image(getClass().getResource("megaman.png").toExternalForm()));
		imagenes.put("item", new Image(getClass().getResource("item.png").toExternalForm()));
	}
